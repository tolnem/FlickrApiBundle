    ...
    public function get($url)
    {
        switch ($url)
        {
            ...
            case 'http://api.flickr.com/services/rest/?method=flickr.photos.search&api_key=a6d472134d5877b51a38070c7c631956&user_id=44774306@N00&per_page=9&extras=path_alias,url_sq,url_t,url_s,url_m,url_z,url_l,url_o':
                ...
                break;
            case 'http://api.flickr.com/services/rest/?method=flickr.photos.search&api_key=76d57011e657bdc87d39202e27c5ef90&user_id=63892273@N06&per_page=12&extras=path_alias,url_sq,url_t,url_s,url_m,url_z,url_l,url_o':
                return \file_get_contents(__DIR__.'/../DataFixtures/Files/recent_12_photos.xml');
                break;
            case 'http://api.flickr.com/services/rest/?method=flickr.photos.search&api_key=76d57011e657bdc87d39202e27c5ef90&user_id=63892273@N06&per_page=3&extras=path_alias,url_sq,url_t,url_s,url_m,url_z,url_l,url_o':
